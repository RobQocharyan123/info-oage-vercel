export const text = [
  ...
  {
    title: 'Early Stage:',
    text: 'Console Protocol is in its early development phase. The goal is to achieve 9.5 million registrations in the first year, with 3 million users actively using Console ID. The Telegram app is driving community growth, while a prototype is being prepared to attract future investors.',
  },

  {
    title: 'Technology and Token:',
    text: 'Console plans to launch its Alphanet testnet in Q2 2025 as a first step toward decentralized data processing. The network will support integration with various blockchains. The TGE and listing of the $CONS token on exchanges are scheduled for Q1 2026. The token will be used for platform governance, transaction fees, and rewarding users for activity and data sharing. It will also incentivize developers to build applications on the protocol.',
  },

  {
    title: 'Partnerships and Plans:',
