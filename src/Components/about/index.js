...
import { AboutGeneralBlock, AboutTextsBlocks } from "./styled";
    ...
    <AboutGeneralBlock>
      ...
      <AboutTextsBlocks>
        ...
        <Paragraph className="paragraph">
          ...
          <span onClick={toggleText} className="more">
            {expanded ? "Less" : "More"}
          </span>
        </Paragraph>
      </AboutTextsBlocks>
